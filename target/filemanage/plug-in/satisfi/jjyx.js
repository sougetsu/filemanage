$(document).ready(function(){
	waixiefeeCountByYear();
	waixiefeeCountByMonth();
	waixiesupplyTop10();
	waixiezhtj();
});
var lableColor = '#fff';
...
function waixiesupplyTop10()
{
	var jjztqk_ = echarts.init(document.getElementById('jjztqk'),'macarons'); 
	$.ajax({
		type : "POST",
		url : "statisticsController.do?listTop10SupplyByYear&reportType=line&applyType=1&year=2019",
...
function waixiefeeCountByMonth()
{
	var xdnyfzqk =echarts.init(document.getElementById('xdnyfzqk'),'macarons'); 
	$.ajax({
		type : "POST",
		url : "statisticsController.do?listTypeCountByMonth&reportType=line&applyType=1",
		success : function(jsondata) {
			jsondata=JSON.parse(jsondata);
...
function waixiezhtj(){
	...
	$.ajax({
		type : "POST",
		url : "statisticsController.do?listZhtjByYear&reportType=line&applyType=1&year=2019",
		success : function(jsondata) {
			jsondata=JSON.parse(jsondata);
...
function waixiefeeCountByYear()
{
	var jjzbwcqk = echarts.init(document.getElementById('jjzbwcqk'),'macarons'); 
	
	$.ajax({
		type : "POST",
		url : "statisticsController.do?listFeeCountByYear&reportType=column&applyType=1&year=2019",
		success : function(jsondata) {
			jsondata=JSON.parse(jsondata);
