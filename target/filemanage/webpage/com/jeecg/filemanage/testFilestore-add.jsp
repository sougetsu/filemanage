...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="testFilestoreController.do?doAdd" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="dlmc" name="dlmc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="pc" name="pc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="rwtzdh" name="rwtzdh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="rwsl" name="rwsl" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="zxgfh" name="zxgfh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="zldj" name="zldj" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fzxs" name="fzxs" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="xpbs" name="xpbs" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="yppc" name="yppc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="yph" name="yph" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
		...
		<div class="form jeecgDetail">
			...
			<script type="text/javascript">
				function jzbghOnUploadStart(file){
					...
					<td class="value">
					     	 <input id="jzdw" name="jzdw" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="wjxh" name="wjxh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="wkjypc" name="wkjypc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="gbxh" name="gbxh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="gbjypc" name="gbjypc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="jhsxh" name="jhsxh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="jhsjypc" name="jhsjypc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="zpjxh" name="zpjxh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="zpjyjpc" name="zpjyjpc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="dbmxh" name="dbmxh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="dbmjypc" name="dbmjypc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
		...
		<div class="form jeecgDetail">
			...
			<script type="text/javascript">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="jdfs" name="jdfs" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
		...
		<div class="form jeecgDetail">
			...
			<script type="text/javascript">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="jdqzsj" name="jdqzsj" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
		...
		<div class="form jeecgDetail">
			...
			<script type="text/javascript">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="bcjybg" name="bcjybg" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="dpzbbg" name="dpzbbg" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
