 ...
 <body>
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						    <input id="dlmc" name="dlmc" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked"  value='${testFilestorePage.dlmc}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="rwtzdh" name="rwtzdh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked"  value='${testFilestorePage.rwtzdh}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="fzxs" name="fzxs" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked"  value='${testFilestorePage.fzxs}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						    <input id="xpbs" name="xpbs" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${testFilestorePage.xpbs}'/>
							<span class="Validform_checktip"></span>
			...
			<script type="text/javascript">
				function jzbghOnUploadStart(file){
					...
					$('#jzbgh').uploadify("settings", "formData", {
						...
						<td class="value">
						    <input id="jzdw" name="jzdw" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${testFilestorePage.jzdw}'/>
							<span class="Validform_checktip"></span>
			...
			<script type="text/javascript">
				function dpabghOnUploadStart(file){
					...
					<tr>
						...
						<td class="value">
						    <input id="bcjybg" name="bcjybg" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${testFilestorePage.bcjybg}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						    <input id="dpzbbg" name="dpzbbg" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${testFilestorePage.dpzbbg}'/>
							<span class="Validform_checktip"></span>
