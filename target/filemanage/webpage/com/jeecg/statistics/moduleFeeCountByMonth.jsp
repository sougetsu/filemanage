...
<body>
	...
	<script type="text/javascript">
		...
		$.ajax({
			type : "POST",
			url : "statisticsController.do?listFeeCountByMonth&reportType=column&applyType=3",
