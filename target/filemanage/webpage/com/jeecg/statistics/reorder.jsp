...
//Echarts线性报表
	$(function() {
		$(document).ready(function() {
			...
			$.ajax({
				type : "POST",
				url : "statisticsController.do?broswerCount&reportType=line",
...
//Echarts柱状报表
	$(function() {
		$(document).ready(function() {
			...
			$.ajax({
				type : "POST",
				url : "statisticsController.do?broswerCount&reportType=column",
				success : function(jsondata) {
					jsondata=JSON.parse(jsondata);
					var data=jsondata[0].data;
					var xAxisData=[];
...
//Echarts饼型报表
	$(function() {
		$(document).ready(function() {
			...
			$.ajax({
				type : "POST",
				url : "statisticsController.do?broswerCount&reportType=pie",
				success : function(jsondata) {
					jsondata=JSON.parse(jsondata);
					var data=jsondata[0].data;
					var xAxisData=[];
...
<div style="width:100%;height:300px;">
	...
	<div id="containerPie" style="float: left; width: 38%; height:100%;"></div>
	<div id="containerCol" style="float: left; width: 30%;height:100%;"></div>
</div>
<div style="width: 100%; height: 333px;">
	<t:datagrid name="部门计划复投统计" title="部门计划复投统计" actionUrl="statisticsController.do?listReorderByJdbc" idField="id" fit="true">
		<t:dgCol title="部门名称" field="id" hidden="true"></t:dgCol>
		<t:dgCol title="部门名称" field="departname" width="130"></t:dgCol>
		<t:dgCol title="复投次数" field="reordersum" width="130"></t:dgCol>
		<t:dgCol title="比例排行" field="rate" width="130"></t:dgCol>
	</t:datagrid>
</div>
<script type="text/javascript">
	$(function(){
