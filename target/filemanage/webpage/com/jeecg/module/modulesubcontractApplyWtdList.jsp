...
<body>
	...
	<div class="panel-body" style="padding-top: 0px; padding-bottom: 0px;">
		...
		<div id="toolbar">
			...
			<button onclick="detail('查看','modulesubcontractApplyController.do?goUpdate','modulesubcontractApplyWtdList','100%','100%')" class="btn btn-info btn-sm">
				<span class="glyphicon glyphicon-search" aria-hidden="true"></span> 查看
			</button>
			<button onclick="ExportXls('导出','','modulesubcontractApplyWtdList',600,400)" id="btn_upload" class="btn btn-info btn-sm">
		...
		<div class="table-responsive">
			...
			<table id="modulesubcontractApplyWtdList"></table>
		</div>
	</div>
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#modulesubcontractApplyWtdList').on(
					'check.bs.table uncheck.bs.table load-success.bs.table '
							+ 'check-all.bs.table uncheck-all.bs.table',
					function() {
						$('#btn_delete').prop('disabled',!$('#modulesubcontractApplyWtdList').bootstrapTable('getSelections').length);
						$('#btn_edit').prop('disabled',$('#modulesubcontractApplyWtdList').bootstrapTable('getSelections').length != 1);
					});
		...
		var TableInit = function() {
			...
			oTableInit.Init = function() {
				$('#modulesubcontractApplyWtdList').bootstrapTable({
									url : 'modulesubcontractApplyController.do?wtddatagrid', //请求后台的URL（*）
									method : 'get', //请求方式（*）
									...
									columns : [
											...
											},
											{
												...
												formatter : function(value,row, index) {
													...
													var pageSize = $('#modulesubcontractApplyWtdList')
															.bootstrapTable('getOptions').pageSize;
													var pageNumber = $('#modulesubcontractApplyWtdList').bootstrapTable('getOptions').pageNumber;
											...
											},
											{
												...
												formatter : function(value,row, index) {
													...
													var href = '';
													href += "<a class='ace_button' href='${pageContext.request.contextPath}/modulesubcontractApplyController/exportWtdWord.do?id="
														+ row.id
		...
		function reloadTable() {
			$('#modulesubcontractApplyWtdList').bootstrapTable('refresh');
		}
	...
	<script type="text/javascript">
		...
		//导入
		function ImportXls() {
			openuploadwin('Excel导入', 'modulesubcontractApplyController.do?upload',"modulesubcontractApplyWtdList");
		}

		//导出
		function ExportXls() {
			JeecgExcelExport("modulesubcontractApplyController.do?exportXls","modulesubcontractApplyWtdList");
		}

		//模板下载
		function ExportXlsByT() {
			JeecgExcelExport("modulesubcontractApplyController.do?exportXlsByT","modulesubcontractApplyWtdList");
		}
