...
<t:formvalid formid="formobj2" tiptype="6" dialog="false" layout="div" action="jeecgFormvalidController.do?testsubmit=2">
	 <fieldset class="step" style="padding-bottom: 20px;">
		<div class="form">
			<label class="Validform_label"> 非空验证： </label> 
		...
		<div class="form">
			<label class="Validform_label"> URL验证： </label> 
			<input type="text" name="demourl2" id="demourl2"> 
			<span class="Validform_checktip"></span>
		</div>
