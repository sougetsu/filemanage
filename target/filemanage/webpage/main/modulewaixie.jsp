...
<body>
	...
	<div class="nh-nav">
		...
		<span id="navMenu2" url="loginController.do?modulewaixie" class="nh-nav-span-selected"> 模块外协</span>
    ...
    <input class="nh-nav-flag" type="hidden" value="navMenu2" />
	<div style="width: 52%;height: 99%; float:left">
		<div id="module_departfee" style="width:98%;height:49%;float:left;  "></div>
		<div id="module_typefee"  style="width:98%;height:49%;float:left; "></div>
	</div>
	<div style="width: 47%;height: 99%; float:left ;">
		<div id="module_supplytop10" style="width:55%;height:98%;float:left;"></div>
		<div id="module_zhtj"  style="width:43%;height:98%;float:left; "></div>
	</div>
<script type="text/javascript" src="${pageContext.request.contextPath}/plug-in/echart/echarts.min.js"></script> 
<script type="text/javascript" src="${pageContext.request.contextPath}/plug-in/satisfi/modulewaixie.js"></script>  
</body></html>