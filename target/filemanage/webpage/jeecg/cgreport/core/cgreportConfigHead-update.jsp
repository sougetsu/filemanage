...
<table style="display: none">
	<tbody id="add_cgreportConfigItem_table_template">
		<tr>
			...
			<td align="left"><input name="cgreportConfigItemList[#index#].replaceVa" maxlength="360" type="text" class="inputxt" style="width: 120px;"></td>
			<td align="left"><input name="cgreportConfigItemList[#index#].dictCode" maxlength="360" type="text" class="inputxt" style="width: 120px;"></td>
