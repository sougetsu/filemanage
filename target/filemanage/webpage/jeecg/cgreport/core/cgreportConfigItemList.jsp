	...
	<tbody id="add_cgreportConfigItem_table">
		<c:if test="${fn:length(cgreportConfigItemList)  <= 0 }">
			<tr>
				...
				<td align="left"><input name="cgreportConfigItemList[0].dictCode" maxlength="360" type="text" class="inputxt" style="width: 120px;"></td>
		...
		<c:if test="${fn:length(cgreportConfigItemList)  > 0 }">
			<c:forEach items="${cgreportConfigItemList}" var="poVal" varStatus="stuts">
				<tr>
					...
					<td align="left"><input name="cgreportConfigItemList[${stuts.index }].dictCode" maxlength="360" type="text" class="inputxt" style="width: 120px;" value="${poVal.dictCode }"></td>
