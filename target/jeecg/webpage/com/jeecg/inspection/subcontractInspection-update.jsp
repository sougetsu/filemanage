...
<script src="plug-in/hplus/plugins/suggest/bootstrap-suggest.min.js"></script>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="subcontractInspectionController.do?doUpdate" method="POST">
		...
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
					<input name="applydate" type="text" class="form-control input-sm laydate-date" value = "${subcontractApply.applydate}" datatype="*" ignore="check"  />
				</div>
			</div>
		</div>
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
					<input name="completedate" type="text" class="form-control input-sm laydate-date" value = "${subcontractApply.completedate}" ignore="ignore"  />
				</div>
			</div>
		</div>
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
					<input name="urgentdate" type="text" class="form-control input-sm laydate-date" value = "${subcontractApply.urgentdate}" ignore="ignore"  />
				</div>
			</div>
		</div>
		<div class="bt-item col-md-12 col-sm-12">
