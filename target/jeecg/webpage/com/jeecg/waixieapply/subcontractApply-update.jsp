...
<script src="plug-in/hplus/plugins/suggest/bootstrap-suggest.min.js"></script>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="subcontractApplyController.do?doUpdate" method="POST">
		<input type="hidden" id="btn_sub" class="btn_sub"/>
		<input type="hidden" id="id" name="id" value="${subcontractApply.id}"/>
		<div class="row">
		<div class="bt-item col-md-12 col-sm-12">
			<div class="row">
	         	<a href="${pageContext.request.contextPath}/subcontractApplyController/exportWord.do?id=${subcontractApply.id}" class="btn btn-info btn-sm">
		...
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
	            	<t:dictSelect id="planadd_jglx" field="wxjglx" type="select"  hasLabel="false" title="外协加工类型" extendJson="{class:'form-control input-sm'}"  typeGroupCode="jglx" defaultVal = "${subcontractApply.wxjglx}" ></t:dictSelect>
				</div>
			</div>
		</div>
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
	            	<t:dictSelect id="plan_wxjgdw" field="wxjgdw" type="select" defaultVal = "${subcontractApply.wxjgdw}" hasLabel="false" title="外协加工单位" extendJson="{class:'form-control input-sm select2',style='width:100%'}"   dictTable="subcontract_supplier" dictField="dwmc" dictText="dwmc" ></t:dictSelect>
				</div>
			</div>
		</div>
		<div class="bt-item col-md-6 col-sm-6">
		...
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
					<input name="applydate" type="text" class="form-control input-sm laydate-date" value = "<fmt:formatDate value='${subcontractApply.applydate}' pattern='yyyy-MM-dd'/>" datatype="*" ignore="check" />
				</div>
			</div>
		</div>
		<div class="bt-item col-md-6 col-sm-6">
		...
		<div ${feeFlag==1? '':'style="display:none"'}  class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
					<input name="bmshsj" type="text" class="form-control input-sm laydate-date" value = "<fmt:formatDate value='${subcontractApply.bmshsj}' pattern='yyyy-MM-dd' />" ignore="ignore"  />
				</div>
			</div>
		</div>
		<div class="bt-item col-md-12 col-sm-12">
		...
		<div ${feeFlag==1? '':'style="display:none"'}  class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
					<input name="bmzgshsj" type="text" class="form-control input-sm laydate-date" value = "<fmt:formatDate value='${subcontractApply.bmzgshsj}' pattern='yyyy-MM-dd' />" ignore="ignore"  />
				</div>
			</div>
		</div>
		<div class="bt-item col-md-12 col-sm-12">
		...
		<div ${feeFlag==1? '':'style="display:none"'}  class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
					<input name="gsldshsj" type="text" class="form-control input-sm laydate-date" value = "<fmt:formatDate value='${subcontractApply.gsldshsj}' pattern='yyyy-MM-dd' />" ignore="ignore"  />
				</div>
			</div>
		</div>
			<div ${feeFlag==1? '':'style="display:none"'}  class="bt-item col-md-6 col-sm-6">
