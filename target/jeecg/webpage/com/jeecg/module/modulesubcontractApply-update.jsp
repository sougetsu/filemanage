...
<script src="plug-in/hplus/plugins/suggest/bootstrap-suggest.min.js"></script>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="modulesubcontractApplyController.do?doUpdate" method="POST">
		...
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
					<input name="cpmc" type="text" class="form-control input-sm" maxlength="32" value = "${modulesubcontractApply.cpmc}" ignore="ignore"  />
				</div>
			</div>
		</div>
		<div class="bt-item col-md-6 col-sm-6">
		...
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
					<input name="yqwcsj" type="text" class="form-control input-sm laydate-date"  maxlength="32" value = "<fmt:formatDate value='${subcontractApply.yqwcsj}' pattern='yyyy-MM-dd' />" ignore="ignore"  />
				</div>
			</div>
		</div>
		...
		<div class="bt-item col-md-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
	            	<t:dictSelect id="moduleadd_wbgys" field="wbgys" type="select" hasLabel="false" title="外包供应商" defaultVal = "${modulesubcontractApply.wbgys}"  extendJson="{class:'form-control input-sm select2',style='width:100%'}" dictTable="subcontract_supplier" dictField="dwmc" dictText="dwmc" ></t:dictSelect>
				</div>
			</div>
		</div>
		<div class="bt-item col-md-6 col-sm-6">
