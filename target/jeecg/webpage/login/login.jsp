...
<head>
  ...
  <link rel="stylesheet" href="plug-in/font-awesome-4.7.0/css/font-awesome.css" />
    ...
    <div class="row">
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center">
            <h2 id="id-text2" class="white">
              <i class="ace-icon fa  fa-microchip black"></i>
              		时代民芯 
            </h2>
            <h3 class="blue" id="id-company-text">外协外包加工管理系统</h3>
          </div>
          ...
          <div class="position-relative">
                 ...
                 <div class="alert alert-warning alert-dismissible" role="alert" id="errMsgContiner">
                  ...
                  <div class="space-6"></div>
                      ...
                      <div class="clearfix">
                        ...
                        <span> | <a href="http://www.mxtronics.com/" target="_blank"><i class="ace-icon fa fa-location-arrow"></i><font color='#428bca'>公司首页</font></a></span>
                         <span> | <a href="http://10.29.31.29:8080/taskmanage" target="_blank"><i class="ace-icon fa fa-cube"></i><font color='#428bca'>任务单系统</font></a></span>
            ...
            <div class="center"><h4 class="blue" id="id-company-text">&copy; 北京时代民芯科技有限公司版权所有</h4></div>
