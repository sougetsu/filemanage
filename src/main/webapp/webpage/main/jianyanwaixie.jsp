...
<link rel="stylesheet" href="plug-in/satisfi/jianyanwaixie.js">
</head>
<body>
	<!--  头部  -->
	<div class="nh-nav">
		<span id="navMenu6" url="loginController.do?hplushome">外协加工</span>
		<span id="navMenu2" url="loginController.do?modulewaixie"> 模块外协</span>
		<span id="navMenu1" url="loginController.do?jianyanwaixie"  class="nh-nav-span-selected">检验外协</span>
    ...
    <input class="nh-nav-flag" type="hidden" value="navMenu1" />
	<div style="width: 52%;height: 99%; float:left">
		<div id="jianyan_departfee" style="width:98%;height:49%;float:left;  "></div>
		<div id="jianyan_typefee"  style="width:98%;height:49%;float:left; "></div>
	</div>
	<div style="width: 47%;height: 99%; float:left ;">
		<div id="jianyan_supplytop10" style="width:55%;height:98%;float:left;"></div>
		<div id="jianyan_zhtj"  style="width:43%;height:98%;float:left; "></div>
	</div>
<script type="text/javascript" src="${pageContext.request.contextPath}/plug-in/echart/echarts.min.js"></script> 
<script type="text/javascript" src="${pageContext.request.contextPath}/plug-in/satisfi/jianyanwaixie.js"></script>  
</body></html>