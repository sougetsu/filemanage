		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<t:hasPermission code="yuanpian">
					<tr >
						...
						<td class="value">
							 <input id="fileupdate_yph" name="yph" class="easyui-combotree" style="width: 150px" class="inputxt"  data-options="url:'${pageContext.request.contextPath}/fileRawMaterialController.do?getXhByType&type=wafer',parentField : 'pid'"
						...
						<td class="value">
							<input id="fileupdate_yppc" name="yppc" class="easyui-combotree" style="width: 150px" class="inputxt"
				...
				<t:hasPermission code="waike">
					<tr>
						...
						<td class="value">
							 <input id="fileupdate_wjxh" name="wjxh" class="easyui-combotree" style="width: 150px" class="inputxt"  data-options="url:'${pageContext.request.contextPath}/fileRawMaterialController.do?getXhByType&type=shell',parentField : 'pid'"
							lines="true" cascadeCheck="false"  value='${testFilestorePage.wjxh}' />
							<span class="Validform_checktip"></span>
						...
						<td class="value">
							<input id="fileupdate_wkjypc" name="wkjypc" class="easyui-combotree" style="width: 150px" class="inputxt"
				...
				<tr>
					...
					<tr>
						...
						<t:hasPermission code="sxqzsj">
							...
							<td class="value">
								<input name="sxqzsj" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" value='${testFilestorePage.sxqzsj}'/>
								<span class="Validform_checktip Validform_right" style="display: none;">文件已上传</span>
							</td>
						</t:hasPermission>
					</tr>
					<t:hasPermission code="sxqj">
					<tr>
						<td align="right" height="38px">
							<label class="Validform_label">
								筛选过程PIND次数:
				...
				<tr>
					...
					<td class="value">
							<t:dictSelect id="fileupdate_jdfs" field="jdfs" type="list"  typeGroupCode="jdfs"  defaultVal="${testFilestorePage.jdfs}" hasLabel="false"  title="鉴定一致性检验方式" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
