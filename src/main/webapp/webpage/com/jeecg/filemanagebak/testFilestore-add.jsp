		...
		<tbody id="add_subcontractJianzhi_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  		<input name="subcontractJianzhiList[#index#].jzdw" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">监制单位</label>
				  </td>
				  <td align="left">
				  ...
				  <td align="left">
										<input type="hidden" id="subcontractJianzhiList[#index#].fileattach" name="subcontractJianzhiList[#index#].fileattach" />
									    <input class="ui-button" type="button" value="上传附件" name="subcontractJianzhiList[#index#].imgBtn"
													onclick="commonUpload(commonUploadDefaultCallBack,'subcontractJianzhiList\\[#index#\\]\\.fileattach')"/>
										<a  target="_blank" id="subcontractJianzhiList[#index#].fileattach_href"></a>
		...
		<tbody id="add_subcontractDpa_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  		<input name="subcontractDpaList[#index#].dpajcjg" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">DPA检测机构</label>
				  </td>
				  <td align="left">
				  ...
				  <td align="left">
					  		<input name="subcontractDpaList[#index#].fileid" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
