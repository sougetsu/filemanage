...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cerProductInfoController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="cpxh" name="cpxh" type="text" maxlength="32" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="jcbgh" name="jcbgh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
