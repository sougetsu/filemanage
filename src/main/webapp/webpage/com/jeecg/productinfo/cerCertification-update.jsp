  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cerCertificationController.do?doUpdate" >
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
							   <input id="hgzupdate_qfrq" name="qfrq" type="text" style="width: 150px" value = "<fmt:formatDate value='${cerCertificationPage.qfrq}' pattern='yyyy-MM-dd'/>"  />    
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td  class="value">
					     	 <input readonly="readonly" name="createName" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" value='${cerCertificationPage.createName}'/>
							<span class="Validform_checktip"></span>
					...
					<td class="value">
							<input name="createDate" type="text" style="width: 150px"   value = "<fmt:formatDate value='${cerCertificationPage.createDate}' pattern='yyyy-MM-dd'/>"  />    
							<span class="Validform_checktip"></span>
