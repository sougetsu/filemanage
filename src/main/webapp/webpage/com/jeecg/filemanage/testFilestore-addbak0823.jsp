  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="testFilestoreController.do?doAdd" callback="jeecgFormFileCallBack@Override">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="qtgd" name="qtgd" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />mm	
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	<input id="fzcpl" name="fzcpl" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />%	
				<span class="Validform_checktip"></span>
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="fzhtrcssl" name="fzhtrcssl" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fzhcshgsl" name="fzhcshgsl" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="fzhcscpl" name="fzhcscpl" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />%
				<span class="Validform_checktip"></span>
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="sxbgh" name="sxbgh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="pindbhgs" name="pindbhgs" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="cpl" name="cpl" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<div class="form jeecgDetail">
			...
			<script type="text/javascript">
				...
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">3σ报告</label>
			</td>
			<td align="right">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">	
		...
		<tr>
			...
			<td class="value">
		     	 <input id="jdyzxjybgh" name="jdyzxjybgh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<div class="form jeecgDetail">
			...
			<script type="text/javascript">
				...
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">鉴定/一致性检验报告附件</label>
			</td>
		</tr>
		<tr>
			<td align="right">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">	
		...
		<tr>
			...
			<td class="value">
		     	 <input id="gdjzh" name="gdjzh" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
