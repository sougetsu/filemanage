...
package com.jeecg.filemanage.page;
 ...
 *
 */
public class TestFilestorePage implements java.io.Serializable {
	/**主键*/
	...
	private List<SubcontractYsxxEntity> subcontractYsxxList = new ArrayList<SubcontractYsxxEntity>();
		...
		public void setSubcontractYsxxList(List<SubcontractYsxxEntity> subcontractYsxxList) {
	...
	private List<SubcontractCqfxxxEntity> subcontractCqfxxxList = new ArrayList<SubcontractCqfxxxEntity>();
		...
		public void setSubcontractCqfxxxList(List<SubcontractCqfxxxEntity> subcontractCqfxxxList) {
	...
	private List<SubcontractBcsxxxEntity> subcontractBcsxxxList = new ArrayList<SubcontractBcsxxxEntity>();
		...
		public void setSubcontractBcsxxxList(List<SubcontractBcsxxxEntity> subcontractBcsxxxList) {
	...
	private List<SubcontractDdsqbgEntity> subcontractDdsqbgList = new ArrayList<SubcontractDdsqbgEntity>();
		...
		public void setSubcontractDdsqbgList(List<SubcontractDdsqbgEntity> subcontractDdsqbgList) {
	...
	private List<SubcontractDpaEntity> subcontractDpaList = new ArrayList<SubcontractDpaEntity>();
		...
		public void setSubcontractDpaList(List<SubcontractDpaEntity> subcontractDpaList) {
	...
	private List<SubcontractJianzhiEntity> subcontractJianzhiList = new ArrayList<SubcontractJianzhiEntity>();
		...
		public void setSubcontractJianzhiList(List<SubcontractJianzhiEntity> subcontractJianzhiList) {
	...
	private List<SubcontractSxbhgqkEntity> subcontractSxbhgqkList = new ArrayList<SubcontractSxbhgqkEntity>();
		...
		public void setSubcontractSxbhgqkList(List<SubcontractSxbhgqkEntity> subcontractSxbhgqkList) {
	...
	private List<SubcontractFzbhgqkEntity> subcontractFzbhgqkList = new ArrayList<SubcontractFzbhgqkEntity>();
		...
		public void setSubcontractFzbhgqkList(List<SubcontractFzbhgqkEntity> subcontractFzbhgqkList) {
