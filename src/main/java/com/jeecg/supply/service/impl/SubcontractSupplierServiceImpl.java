package com.jeecg.supply.service.impl;
...
@Service("subcontractSupplierService")
@Transactional
public class SubcontractSupplierServiceImpl extends CommonServiceImpl implements SubcontractSupplierServiceI {
