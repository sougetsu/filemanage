package com.jeecg.supplywb.entity;
 ...
 */
@Entity
@Table(name = "subcontract_supplier_module", schema = "")
@SuppressWarnings("serial")
public class SubcontractSupplierModuleEntity implements java.io.Serializable {
	/**主键*/
	...
	/**产品名称*/
	@Excel(name="产品名称",width=15,dicCode="jglx")
	...
	@Column(name ="DWMC",nullable=true,length=100)
	...
	@Column(name ="DZ",nullable=true,length=320)
