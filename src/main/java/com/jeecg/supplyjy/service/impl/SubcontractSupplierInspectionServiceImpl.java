package com.jeecg.supplyjy.service.impl;
...
@Service("subcontractSupplierInspectionService")
@Transactional
public class SubcontractSupplierInspectionServiceImpl extends CommonServiceImpl implements SubcontractSupplierInspectionServiceI {
