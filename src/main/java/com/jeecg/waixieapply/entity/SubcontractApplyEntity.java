package com.jeecg.waixieapply.entity;
 ...
 */
@Entity
@Table(name = "subcontract_apply", schema = "")
@SuppressWarnings("serial")
public class SubcontractApplyEntity implements java.io.Serializable {
	/**主键*/
