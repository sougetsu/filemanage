package com.jeecg.module.service.impl;
...
@Service("modulesubcontractApplyService")
@Transactional
public class ModulesubcontractApplyServiceImpl extends CommonServiceImpl implements ModulesubcontractApplyServiceI {
