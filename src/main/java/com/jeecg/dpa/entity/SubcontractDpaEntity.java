 ...
 */
@Entity
@Table(name = "subcontract_dpa", schema = "")
@SuppressWarnings("serial")
public class SubcontractDpaEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.String dpastarttime;
	/**DPA试验结束时间*/
	@Excel(name="DPA试验结束时间",width=15)
	private java.lang.String dpaendtime;
	/**文件id*/
	private java.lang.String fileid;
	/**文件上传*/
	@Excel(name="文件上传",width=15)
	private java.lang.String dpafileattach;
	...
	@Column(name ="DPABGH",nullable=true,length=32)
	...
	@Column(name ="DPAJCJG",nullable=true,length=200)
	...
	@Column(name ="DPASTARTTIME",nullable=true,length=32)
	public java.lang.String getDpastarttime(){
		return this.dpastarttime;
	}
	 ...
	 */
	public void setDpastarttime(java.lang.String dpastarttime){
		this.dpastarttime = dpastarttime;
	}
	...
	@Column(name ="DPAENDTIME",nullable=true,length=32)
	public java.lang.String getDpaendtime(){
		return this.dpaendtime;
	}
	 ...
	 */
	public void setDpaendtime(java.lang.String dpaendtime){
		this.dpaendtime = dpaendtime;
	}
	...
	@Column(name ="DPAFILEATTACH",nullable=true,length=500)
	public java.lang.String getDpafileattach(){
		return this.dpafileattach;
	}
	 ...
	 */
	public void setDpafileattach(java.lang.String dpafileattach){
		this.dpafileattach = dpafileattach;
	}
